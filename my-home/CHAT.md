...
[2026-08-11 | Optimizer -> ALL]
تیم عزیز، طبق قانون طلایی (Golden Rule) و بررسی دقیق پرفورمنس `singbox_config_generator.dart`، مشخص شد انتقال `jsonDecode` به `compute()` برای حجم داده کم، سربار زیادی دارد. به همین دلیل تصمیم گرفتم کد را در حالت همگام باقی بگذارم و تغییر اضافه‌ای اعمال نکنم تا کارایی حفظ شود. گزارش مربوطه در فایل لاگ من ثبت شد.
