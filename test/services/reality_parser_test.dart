...
void main() {
  group('Reality Parser Tests', () {
    test('Should parse standard VLESS URI with Reality correctly', () {
      const uri =
          "vless://uuid@example.com:443?security=reality&sni=example.com&fp=chrome&pbk=789&sid=123&type=tcp&headerType=none#Example";
      final config = SingboxConfigGenerator.generateConfig(uri,
          listenPort: 10808, isTest: true);
    ...
    test(
        'Should parse VLESS URI with missing pbk in query but present in Base64 JSON fallback',
        () {
      ...
      const base64Part =
          "eyJhZGQiOiIxLjEuMS4xIiwicG9ydCI6NDQzLCJpZCI6InV1aWQiLCJzY3kiOiJyZWFsaXR5Iiwic25pIjoiZXhhbXBsZS5jb20iLCJwYmsiOiIxMjM0NTYiLCJzaWQiOiJzaG9ydCJ9";
      const rawLink = "vless://$base64Part";

      final config = SingboxConfigGenerator.generateConfig(rawLink,
          listenPort: 10808, isTest: true);
    ...
    test('Should fallback to standard VLESS when pbk is missing', () {
      ...
      const base64Part =
          "eyJhZGQiOiIxLjEuMS4xIiwicG9ydCI6NDQzLCJpZCI6InV1aWQiLCJzY3kiOiJyZWFsaXR5In0=";
      const rawLink = "vless://$base64Part";
    ...
    test('Should handle VLESS URI with mixed casing and encoded characters',
        () {
      const uri =
          "vless://UUID@Example.Com:443?security=reality&pbk=ABC&sid=123#Tag";
      final config = SingboxConfigGenerator.generateConfig(uri,
          listenPort: 10808, isTest: true);
